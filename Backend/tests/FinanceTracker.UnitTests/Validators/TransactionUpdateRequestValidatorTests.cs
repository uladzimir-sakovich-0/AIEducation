...
/// <summary>
/// Tests for TransactionUpdateRequestValidator
/// </summary>
public class TransactionUpdateRequestValidatorTests
{
    private readonly TransactionUpdateRequestValidator _validator;

    public TransactionUpdateRequestValidatorTests()
    {
    ...
    public void WhenAmountIsNegative_ThenValidationPasses()
    {
        ...
        var request = new TransactionUpdateRequest
        {
            ...
            Timestamp = DateTime.UtcNow,
            CategoryId = Guid.NewGuid(),
            Notes = "Updated expense transaction"
        };
    ...
    public void WhenAmountIsPositive_ThenValidationPasses()
    {
        ...
        var request = new TransactionUpdateRequest
        {
            ...
            Timestamp = DateTime.UtcNow,
            CategoryId = Guid.NewGuid(),
            Notes = "Updated income transaction"
        };
